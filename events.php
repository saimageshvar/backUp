...
<body class="home page page-id-4 page-template page-template-template-homepage page-template-template-homepage-php  one-page">
	...
	<span class="cssload-loader events-loader"><span class="cssload-loader-inner"></span></span>

	<div class="main" data-nav-position="left" style="">			
		<section class="section  random"
		data-background-image=""
		data-background="rgba(30,45,58,0.80)"
		data-shadow=""
		data-nav-color="rgba(30,45,58,0)"
			...
			<div class="row">
				<div class="filter-box works-box">
					<div class="row section-title-block">
						<h1 class="col-sm-4 section-title" data-appear-animation="fadeInLeftBig" data-appear-animation-delay="500">Events</h1>
						...
						<div class="col-sm-8 text-right" data-appear-animation="fadeInRightBig" data-appear-animation-delay="500">
							<div class="btn-group filter-buttons filter-list">
								...
								<ul class="dropdown-menu" role="menu">
									<li><a href="#" id="Engineering" onclick='swapDomains(this);' class="active" style="font-family: 'Aref Ruqaa', serif;">Engineering</a></li>
									<li><a href="#" id="Online" onclick='swapDomains(this);' style="font-family: 'Aref Ruqaa', serif;">Online</a></li>
...
<script>
	...
	var url = "http://enct29fa5ae.kurukshetra.org.in/events.json";
