...
<body class="home page page-id-4 page-template page-template-template-homepage page-template-template-homepage-php  one-page">
	...
	<span class="cssload-loader workshops-loader"><span class="cssload-loader-inner"></span></span>
		...
		<div class="section-content ">
			...
			<div class="filter-box works-box">
				<div class="row section-title-block">
					<h1 class="col-sm-4 section-title" data-appear-animation="fadeInLeftBig" data-appear-animation-delay="100">Workshops</h1>

					<div class="col-sm-8 text-right" data-appear-animation="fadeInRightBig" data-appear-animation-delay="100">
...
<script>
	...
	var url = "http://enct29fa5ae.kurukshetra.org.in/workshops.json";
