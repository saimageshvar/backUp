...
<div class="section-content ">
    ...
    <div class="row section-title-block">
        <h1 style="color:rgb(255, 247, 204);" class="col-sm-8 section-title" data-appear-animation="fadeInDown" data-appear-animation-delay="100">Reach Us</h1>
        <br/>
...
<!-- dashboard -->
<div class="modal fade dashboard" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h2 class="modal-title" style="text-align:center;margin-top:30px">Your Dashboard</h2>
            </div>
            <div class="modal-body" style="color:black">
                <div class="row">
                ...
                <?php } 
                    ...
                    <?php } ?>
                    <!-- workshops -->
                    <?php if(isset($_SESSION['user']['workshops'])) {?>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <ul class="list-group">
                            ...
                            <?php foreach ($_SESSION['user']['workshops'] as $workshop => $flag) {
                                echo"<li class='list-group-item'>".$workshop."</li>";
                            }?>
                        </ul>
                    </div>
                    <?php } 
